...
?>
<body>
  <h1> Hi <?php echo $displayName . "," ?> report a missing pet! </h1>
  <a href="../index.php"> &lt; Home </a> <br> <br>
  <div class="form-outer">
    <div class="entry-form">
      <form method="POST" action="missing.php" enctype="multipart/form-data">
        <div class="component">
          ...
          <label for="lat"> Last Seen Location Latitude (Optional)</label>
          <input id="lat" type="text" name="lat" placeholder="37">
          <br><br>
          <label for="lon"> Last Seen Location Longitude (Optional)</label>
